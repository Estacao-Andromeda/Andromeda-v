...
chat-radio-message-wrap = [color={ $color }]{ $channel } { $name } { $verb }, [font={ $fontType }  Tamanho={ $fontSize }]"{ $message }"[/font][/color]

chat-radio-message-wrap-bold = [color={ $color }]{ $channel } { $name } { $verb }, [font={ $fontType }  Tamanho={ $fontSize }][bold]"{ $message }"[/bold][/font][/color]
...
chat-radio-science = Epistêmicos

chat-radio-security =  Segurança.

chat-radio-service =  Serviço

chat-radio-supply =  Logística

...
/// <summary>
/// Shared component for canvas entities that allow players to draw and display art.
/// Handles networked state synchronization between client and server.
/// </summary>
...
{
    /// <summary>
    /// The currently selected drawing state or decal ID.
    /// </summary>
    ...
    /// <summary>
    /// The current drawing color used for painting.
    /// </summary>
    [DataField("color")]
    ...
    /// <summary>
    /// The encoded string representing the painting data (colors for each pixel).
    /// </summary>
    ...
    /// <summary>
    /// The name of the artist who created or finalized the painting.
    /// </summary>
    [DataField("artist")]
    ...
    /// <summary>
    /// The signature or custom name provided by the artist.
    /// </summary>
    [DataField("signature")]
    ...
    public int Width
    {
        ...
        set
        {
            ...
            _width = value;
            // Note: There was a commented line here that seems erroneous: //Nwidth = value;
            Dirty();
        }
    }

    /// <summary>
    /// The multiplier for pixel size when rendering the canvas texture.
    /// </summary>
    [DataField("size")]
    ...
    /// <summary>
    /// Indicates whether the color can be selected by the user (e.g., for rainbow canvases).
    /// </summary>
